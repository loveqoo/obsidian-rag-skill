...
echo "=== Setup Complete ==="
echo ""
echo "📍 Next steps - Run from project root directory:"
echo ""
echo "  # Quick commands using wrapper script:"
echo "  ./obsidian-rag full-index              # Full indexing"
echo "  ./obsidian-rag search --query \"term\"  # Semantic search"
echo "  ./obsidian-rag incremental-update      # Update changed files"
echo "  ./obsidian-rag stats                   # Show statistics"
echo ""
echo "💡 If you don't need the wrapper script, delete it: rm ./obsidian-rag"
echo ""
echo "🔗 Direct commands (without wrapper):"
echo "  ./.claude/skills/obsidian-rag/.venv/bin/python ./.claude/skills/obsidian-rag/scripts/obsidian_rag.py full-index"
echo ""
